...
VideoConverter::VideoConverter(std::shared_ptr<AVCodecContext> &video_codec_context) : video_codec_context_(video_codec_context) {}
...
int VideoConverter::getFrame(std::shared_ptr<AVFrame>& in, std::shared_ptr<AVFrame>& out) {
